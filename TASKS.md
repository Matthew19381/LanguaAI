...
- [x] **Automatyczne (bez klikania) dogenerowanie po serii błędów na tej samej umiejętności** ✅ 2026-07-25
    ...
    - Testy: `test_exercise_auto_variant.py` (9: warunki triggera + 4 scenariusze endpointu — trigger / poprawna / dobry skill / replay). Backend 430 passed, frontend 67 passed, build OK.
    - _Uwaga:_ live trigger (seria błędów → dogenerowanie) nie odpalony w przeglądarce, by nie palić kredytów AI; logika pokryta testami jednostkowymi + endpointowymi z mockiem AI.
