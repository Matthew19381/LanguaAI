...
_Ostatnia aktualizacja: 2026-08-19 — dodane fiszki: tryb kontekstu/cloze, wymuszona produkcja dla trudnych kart, kontekst krzyżowy na żądanie (Wariant B+D, sekcja 1). Wcześniej tego samego dnia: hierarchia tematów + mastery % (P2-4). Wcześniej (2026-08-07): SCI-1…SCI-7 przeniesione z backlogu (sekcja 4) do „Stan faktyczny" (sekcja 1), zgodnie z rzeczywistym stanem kodu._
